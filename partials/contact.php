<div class="row--padding grey" id="contact">

  <div class="row">
    <div class="small-6 columns">
      <h2 class="section-heading text-center">Contact Me</h2>
      <p class="text-center">
  ...
  <div class="row">
    ...
    <div class="small-6 medium-2 large-2 columns">
      ...
      <p class="social">
        ...
        <a href="https://twitter.com/milzaaam" title="Me on Twitter"><i class="icon icon-twitter icon-2x"></i></a>
        <a href="https://plus.google.com/116499314183216878484/posts" title="Me on Google Plus"><i class="icon icon-googleplus icon-2x"></i></a>
      </p>
