<div class="pv+" id="work">
  ...
  <div class="grid divider pv+">
    ...
    <div class="grid__item small-1 medium-1of2">
      ...
      <p class="text-bold mb--">Used in this project:</p>
      ...
      <a href="http://demo.ahmadmilzam.com/asoris" title="View Website" class="btn btn--asoris">
  ...
  <div class="grid divider pv+">
    ...
    <div class="grid__item small-1 medium-1of2">
      ...
      <a href="http://demo.ahmadmilzam.com/muse" title="View Website" class="btn btn--muse">
        View Website <svg class="icon icon--paper-plane"><use xlink:href="#icon--paper-plane"></use></svg>
      </a>
    </div>
  </div>
  ...
  <div class="grid divider pv+">
    ...
    <div class="grid__item small-1 medium-1of2">
      ...
      <a href="http://qualixen.com" title="View Website" class="btn btn--qualixen">
        View Website <svg class="icon icon--paper-plane"><use xlink:href="#icon--paper-plane"></use></svg>
      </a>
    </div>
  </div>
  ...
  <div class="grid pv+">
    ...
    <div class="grid__item small-1 medium-1of2">
      ...
      <a href="http://demo.ahmadmilzam.com/anona" title="View Website" class="btn btn--anona">
        View Website <svg class="icon icon--paper-plane"><use xlink:href="#icon--paper-plane"></use></svg>
      </a>
    </div>
  </div>
